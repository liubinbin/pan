...
//	}
     ...
     *                   from this iterator.
     * @param str        If non-null, new entries are created from keys and possibly values
     *                   read from this stream in serialized form. Exactly one of it and
     *                   str should be non-null.
     * @param defaultVal if non-null, this default value is used for each value in the map.
